...
<head>
    ...
    <title>อัปเดตข้อมูลสำเร็จ</title>
...
<body>
    <div class="success-card">
        ...
        <!-- Title -->
        <h3 class="fw-bold text-white mb-2">อัปเดตข้อมูลสำเร็จ!</h3>

        <!-- Message -->
        <p class="text-secondary mb-4">
            ระบบได้บันทึกการแก้ไขข้อมูลพนักงานขับรถเรียบร้อยแล้ว
        </p>

        <!-- Buttons -->
        <div class="d-flex justify-content-center gap-2">
            <a href="{{ url()->previous() }}" class="btn btn-outline-light px-4 py-2">
                <i class="bi bi-arrow-left-short me-1"></i> กลับไปแก้ไข
            </a>

            <a href="/" class="btn btn-primary px-4 py-2">
                <i class="bi bi-house-fill me-1"></i> หน้าแรก
            </a>
        </div>
    </div>
</body>
